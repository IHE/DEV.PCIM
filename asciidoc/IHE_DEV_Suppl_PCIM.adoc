...
|Association Time
|R
|Timestamp when the device-patient association starts.

|Disassociation Time
|C
|Timestamp when the device-patient association ends. Required for disassociation events and optional when unknown at the time of association.
...
|O
|Location recorded when the association occurs.

|Location at Disassociation
|O
|Location recorded when the disassociation occurs.

|Originating Participant
|R
|Participant that initiated the association/disassociation event. May be a person or a system/device.

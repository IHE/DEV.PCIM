...
| _Section A.3 - Example Messages_  *Example 2, DEV 51 associate message*, update the example to assign unique identifier by reporter to OBR.3 for association using additional field in EI.
...
| _Section A.3 - Example Messages_  *Example 3, DEV 52 associate message*, update the example to assign unique identifier by manager to OBR.3 for association, making it different from DEV-51 sent by reporter earlier in Example 2 and also using EUI-64 encoding:

...
A Device-Patient Association Reporter asserts a identifiable person authored and validated device-patient association to a Device-Patient Association Manager.
...
==== 7.4.2.1 Use Case #2: Identifiable person reporting an association requiring validation

===== 7.4.2.1.1 Description

A Device-Patient Association Reporter asserts a identifiable person authored a device-patient association requiring validation to a Device-Patient Association Manager.
...
When such an association message is received, the manager system is responsible fordetermining if any conflicting information is in the system and generating an appropriate error message to assist the responsible personnel in resolving the conflict. The manager system is also responsible for notifying the appropriate person to validate the association.
...
==== 7.4.2.1 Use Case #3: System, possibly with anonymous person input, asserting a validated association
...
==== 7.4.2.1 Use Case #4: System, possibly with anonymous person input, reporting an association requiring validation
...
==== 7.4.2.2 Use Case #5: Disassociating Device From Patient
...
==== 7.4.2.3 Use Case #6 Filter Devices for a Patient

...
|Kurt Elliason, kurt.elliason@icumed.com
...
| _3.52.4.1.2 in PCIM TI - Message Semantics_, update the first bullet to include considerations for patient identity corrections: 
...
| _3.52.4.1.3 in PCIM TI - Message Semantics_, add another subsection, 3.52.4.1.3 Correction Semantics to specify the semantics of corrections: 
...
**Table 3.52.4.1.3-1: Correctable Parameters for Active Associations**
[%autowidth]
|===
|Parameter|Semantics
...
**Table 3.52.4.1.3-2: Correctable Parameters for Completed Associations**
[%autowidth]
|===
|Parameter|Semantics
...
| _3.52.4.1.4 in PCIM TI - Message Semantics_, add another subsection, 3.52.4.1.4 Wrong Semantics to specify the semantics of wrong associations: 

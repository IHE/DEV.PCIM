...
As stated previously, the DEV-19 transaction is optional. The Device-Patient Association Manager _shall_ return an appropriate error status to the Device-Patient Association Consumer if it does not support this transaction.

...
|_Section 7.1.1.4_ *Device-Registrant*, delete the two paragraphs starting at line 287 and tie them into an MEM DMC reference_:
...
|*7.4.2.4.1 Description*, _update to reflect query vs filtering nomenclature changes_:
...
|*7.4.2.4.2 Process Flow*, _remove query text and add detail_:
...
|*A.1.2.1 Message Structure*, _update paragraph on line 724, to reference new transaction numbering and fix typo in OID_:
...
[underline]#Proposed Text:#
[.text-left]
Since this message is effectively an unsolicited observation report, the contents of the MSH segment follow the specifications for [PCD-01] in PCD TF-2 Appendix B.1, except that MSH-21 is valued "IHE_PCD_051^IHE PCD\^1.3.6.1.4.1.19376.1.6.4.51.1^ISO" to identify it as a message representing a device-patient association.
...
[underline]#Proposed Text:#
[.text-left]
As for transaction [PCD-01] in PCD TF-2 Appendix B.1, except that MSH-21 is valued as IHE_PCD_052^IHE PCD\^1.3.6.1.4.1.19376.1.6.4.52.1^ISO.
...
[underline]#Proposed Text:#
[.text-left]
|AL||8859/1|||IHE_PCD_051^IHE PCD\^1.3.6.1.4.1.19376.1.6.4.51.1^ISO

|===

|*A.4 Example Messages*, _update manager application level acknowledgementfor Example 1 on line 1005 to use the new transaction numbering_:
...
[underline]#Proposed Text:#
[.text-left]
7|||AL|AL||8859/1|||IHE_PCD_051^IHE PCD\^1.3.6.1.4.1.19376.1.6.4.51.1^ISO
|===

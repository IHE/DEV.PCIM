...
|*A.1.2.5-2*, _update table to reflect terms assigned for device-patient association and disassociation and remove text below discussion potenetial for spot vitals collection alternatives_
|===

...
l|   PRT
| Participation -- _One PRT segment for device, one for responsible person or system, optional third for additional person doing validation_
| R
| [2..3]

l| ]
| --- ORDER_OBSERVATION_END
|
|
